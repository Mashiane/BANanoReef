...
Sub SetSpan(sText As String) As UOEHTML
...
'set vertical
Sub SetVertical(b As Boolean) As UOEHTML   'ignore
	AddClass("vertical")
	Return Me
End Sub

'set dark
Sub SetDark(b As Boolean) As UOEHTML   'ignore
	AddClass("dark")
	Return Me
End Sub

'set box colored
Sub SetBoxColored(b As Boolean) As UOEHTML  'ignore
	AddClass("box-colored")
	Return Me
End Sub

'set section
Sub SetSection(b As Boolean) As UOEHTML   'ignore
	AddClass("section")
	Return Me
End Sub

Sub SetContent(c As String) As UOEHTML
	AddContent(c)
	Return Me
End Sub

'set double padded
Sub SetDoublePadded(b As Boolean) As UOEHTML   'ignore
	AddClass("double-padded")
	Return Me
End Sub

'wrap element to
Sub Wrap(wid As String, wrapType As String) As UOEHTML
	Dim p As UOEHTML
	p.Initialize(wid).SetTag(wrapType)
	p.AddContent(HTML)
	Return p 
End Sub

'set row
Sub SetRow(b As Boolean) As UOEHTML   'ignore
	AddClass("row")
	Return Me
End Sub

'set responsive padding
Sub SetResponsivePadding(b As Boolean) As UOEHTML   'ignore
...
Sub SetResponsiveMargin(b As Boolean) As UOEHTML   'ignore
	AddClass("responsive-margin")
	Return Me
End Sub

'set inverse
Sub SetInverse(b As Boolean) As UOEHTML   'ignore
	AddClass("inverse")
	Return Me
End Sub

'set tertiary
Sub SetTertiary(b As Boolean) As UOEHTML   'ignore
	AddClass("tertiary")
	Return Me
End Sub

'set secondary
Sub SetSecondary(b As Boolean) As UOEHTML   'ignore
	AddClass("secondary")
	Return Me
End Sub

'set primary
Sub SetPrimary(b As Boolean) As UOEHTML  'ignore
	AddClass("primary")
	Return Me
End Sub
...
'set circular
Sub SetCircular(b As Boolean) As UOEHTML  'ignore
	AddClass("circular")
	Return Me
End Sub

'set bordered
Sub SetBordered(b As Boolean) As UOEHTML   'ignore
	AddClass("bordered")
	Return Me
End Sub

'set shadowed
Sub SetShadowed(b As Boolean) As UOEHTML  'ignore
	AddClass("shadowed")
	Return Me
End Sub

'set rounded
Sub SetRounded(b As Boolean) As UOEHTML   'ignore
	AddClass("rounded")
	Return Me
End Sub

'set the tooltip
Sub SetToolTip(tt As String) As UOEHTML
	AddClass("tooltip")
	SetAttr("aria-label", tt)
	Return Me
End Sub

Sub SetAttr(attr As String, val As String) As UOEHTML
	AddAttribute(attr,val)
	Return Me
End Sub

'set role button
Sub SetRoleButton(b As Boolean) As UOEHTML   'ignore
	SetROLE("button")
	Return Me
End Sub

'set disabled
Sub SetDisabled(b As Boolean) As UOEHTML
	If b Then AddLooseAttribute("disabled")
	Return Me
End Sub

'set small
Sub SetSmall(b As Boolean) As UOEHTML
	AddClassOnCondition(b, "small")
	Return Me
End Sub

'set large
Sub SetLarge(b As Boolean) As UOEHTML
	AddClassOnCondition(b, "large")
	Return Me
End Sub


Sub SetImportant(b As Boolean) As UOEHTML
	IsImportant = b
	Return Me
End Sub

'set style
Sub SetStyle(prop As String, val As String) As UOEHTML
	AddStyle(prop,val)
	Return Me
End Sub

'set width
Sub SetWidth(w As Object) As UOEHTML
	AddAttribute("width", w)
	Return Me
End Sub

'set width
Sub SetCSS(w As Object) As UOEHTML
	AddAttribute("css", w)
	Return Me
End Sub

'set height
Sub SetHeight(h As String) As UOEHTML
	AddAttribute("height", h)
	Return Me
End Sub

Sub SetPadding(PaddingBottom As String) As UOEHTML
	AddStyleAttribute("padding", MakePx(PaddingBottom))
	Return Me
End Sub

Sub SetPaddingBottom(PaddingBottom As String) As UOEHTML
	AddStyleAttribute("padding-bottom", MakePx(PaddingBottom))
	Return Me
End Sub

Sub SetPaddingRight(PaddingRight As String) As UOEHTML
	AddStyleAttribute("padding-right", MakePx(PaddingRight))
	Return Me
End Sub

Sub SetPaddingLeft(PaddingLeft As String) As UOEHTML
	AddStyleAttribute("padding-left", MakePx(PaddingLeft))
	Return Me
End Sub
	
Sub SetPaddingTop(PaddingTop As String) As UOEHTML
	AddStyleAttribute("padding-top", MakePx(PaddingTop))
	Return Me
End Sub

Sub SetMargin(MarginBottom As String) As UOEHTML
	AddStyleAttribute("margin", MakePx(MarginBottom))
	Return Me
End Sub

Sub SetMarginBottom(MarginBottom As String) As UOEHTML
	AddStyleAttribute("margin-bottom", MakePx(MarginBottom))
	Return Me
End Sub

Sub SetMarginRight(MarginRight As String) As UOEHTML
	AddStyleAttribute("margin-right", MakePx(MarginRight))
	Return Me
End Sub

Sub SetMarginLeft(MarginLeft As String) As UOEHTML
	AddStyleAttribute("margin-left", MakePx(MarginLeft))
	Return Me
End Sub
	
Sub SetMarginTop(MarginTop As String) As UOEHTML
	AddStyleAttribute("margin-top", MakePx(MarginTop))
	Return Me
End Sub

Sub UseTheme(sPrefix As String, themeName As String) As UOEHTML
...
Sub AddAttributeIfSet(prop As String, value As String) As UOEHTML
	If value <> "" Then
...
Sub SetPlaceHolder(sPlaceholder As String) As UOEHTML
	AddAttribute("placeholder",sPlaceholder)
	Return Me
End Sub

Sub SetTITLE(stitle As String) As UOEHTML
	AddAttribute("title", stitle)
	Return Me
End Sub

Sub SetREL(rel As String) As UOEHTML
	AddAttribute("rel", rel)
	Return Me
End Sub

'clear contents
Sub Clear As UOEHTML
	Contents.clear
	Return Me
End Sub

Sub AddPropertyOnCondition(bCondition As Boolean, attr As String, value As String) As UOEHTML
	If bCondition Then
...
Public Sub AddProperty(sKey As String, sValue As String) As UOEHTML
	AddAttribute(sKey, sValue)
	Return Me
End Sub

Sub SetTARGET(sValue As String) As UOEHTML
	If sValue.Trim = "" Then Return Me
	AddAttribute("target",sValue)
	Return Me
End Sub

Sub SetTargetBlank(b As Boolean) As UOEHTML   'ignore
	SetTARGET("_blank")
	Return Me
End Sub

Sub SetTargetSelf(b As Boolean) As UOEHTML    'ignore
	SetTARGET("_self")
	Return Me
End Sub
	
Sub SetTargetParent(b As Boolean) As UOEHTML   'ignore
	SetTARGET("_parent")
	Return Me
End Sub
	
Sub SetTargetTop(b As Boolean) As UOEHTML    'ignore
	SetTARGET("_top")
	Return Me
End Sub

Sub ApplyStyle(sStyle As String) As UOEHTML
...
public Sub SetContents(value As String) As UOEHTML
	Contents.Initialize
	Contents.clear
...
public Sub AddElementLine(el As UOEHTML) As UOEHTML
	If el <> Null Then
...
Sub SetROLE(sValue As String) As UOEHTML
	AddAttribute("role",sValue)
	Return Me
End Sub

Sub SetMETHOD(sValue As String) As UOEHTML
	AddAttribute("method",sValue)
	Return Me
End Sub

'add content to the element
public Sub AddContentLine(value As String) As UOEHTML
	If value <> "" Then
...
Sub SetTypeNumbers() As UOEHTML
	AddAttribute("type","1")
	Return Me
End Sub

Sub SetTypeUpperCase() As UOEHTML
	AddAttribute("type","A")
	Return Me
End Sub

Sub SetTypeLowerCase() As UOEHTML
	AddAttribute("type","a")
	Return Me
End Sub

Sub SetTypeUpperCaseRoman() As UOEHTML
	AddAttribute("type","I")
	Return Me
End Sub

Sub SetTypeLowerCaseRoman() As UOEHTML
	AddAttribute("type","i")
	Return Me
End Sub


Sub SetListStyleCircle() As UOEHTML
	AddStyleAttribute("list-style-type","circle")
	Return Me
End Sub

Sub SetListStyleDisk() As UOEHTML
	AddStyleAttribute("list-style-type","disk")
	Return Me
End Sub

Sub SetListStyleNone() As UOEHTML
	AddStyleAttribute("list-style-type","none")
	Return Me
End Sub

Sub SetListStyleSquare() As UOEHTML
	AddStyleAttribute("list-style-type","square")
	Return Me
End Sub

Sub AddHeading(sSize As Int, sContent As String) As UOEHTML
	Dim hdr As UOEHTML
	Dim hKey As String = "h" & sSize
	hdr.Initialize("").SetTag(hKey)
	hdr.AddContent(sContent)
	AddContent(hdr.HTML)
	Return Me
End Sub

Sub AddParagraph(sContent As String) As UOEHTML
	Dim p As UOEHTML
	p.Initialize("").SetTag("p")
	p.AddContent(sContent)
	AddContent(p.HTML)
	Return Me
End Sub

Sub AddMark(sContent As String, sclass As String) As UOEHTML
	Dim p As UOEHTML
	p.Initialize("").SetTag("mark").AddClass(sclass)
	p.AddContent(sContent)
	AddContent(p.HTML)
	Return Me
End Sub
...
Sub AddLooseAttributeOnFalseCondition(bStatus As Boolean, value As String) As UOEHTML
...
Sub SetElementTypeOnCondition(bStatus As Boolean,sElementType As String) As UOEHTML
	If bStatus Then
		Tag = sElementType
	End If
	Return Me
...
Sub SetZIndex(zindex As String) As UOEHTML
	AddStyleAttribute("z-index",zindex)
	Return Me
End Sub

Sub AddContentListReverse(lst As List) As UOEHTML
...
Sub SetFOR(sFor As String) As UOEHTML
	AddAttribute("for",sFor)
	Return Me
End Sub


Sub SetVALUE(sValue As String) As UOEHTML
	AddAttribute("value",sValue)
	Return Me
End Sub


Sub SetNAME(sName As String) As UOEHTML
	AddAttribute("name",sName)
	Return Me
End Sub

Sub SetTYPE(sValue As String) As UOEHTML
	AddAttribute("type",sValue)
	Return Me
End Sub


Sub UpdateAttribute(name As String, propValue As String) As UOEHTML
...
'add a class to the element
Sub AddLooseAttributeOnCondition(bStatus As Boolean, value As String) As UOEHTML
...
'add a class to the element
Sub AddLooseAttribute(value As String) As UOEHTML
...
Sub AddDataAttribute(attribute As String, value As String) As UOEHTML
...
Sub AddDataAttributeOnCondition(bCondition As Boolean,attribute As String, value As String) As UOEHTML
...
Sub AddStyleOnCondition(bCondition As Boolean,attribute As String, value As String) As UOEHTML
	If bCondition = False Then 
		Return Me
	End If
...
Sub SetSRC(sValue As String, Static As Boolean) As UOEHTML
...
Sub SetALT(sValue As String) As UOEHTML
	AddAttribute("alt",sValue)
	Return Me
End Sub

Sub SetWidthPX(Width As String) As UOEHTML
	If Width <> "" Then
...
Sub SetHeightPX(Height As String) As UOEHTML
	If Height <> "" Then
...
Sub AddStyleAttributeOnCondition(bCondition As Boolean, attr As String, value As String) As UOEHTML
...
Sub AddAttributeOnCondition(bCondition As Boolean, attr As String, value As String) As UOEHTML
	If bCondition = True Then
		AddAttribute(attr,value)
	End If
	Return Me
...
Sub AddCursor As UOEHTML
	AddStyleAttribute("cursor", "pointer")
	Return Me
End Sub

Sub SetHREF(value As String) As UOEHTML
	AddAttribute("href",value)
	Return Me
End Sub

Sub AddClassOnValue(iValue As Int, sClass As String) As UOEHTML
	If iValue > 0 Then
		AddClass(sClass)
	End If
	Return Me
...
Sub AddClassOnCondition(bCondition As Boolean, sClass As String) As UOEHTML
	If bCondition  Then
		AddClass(sClass)
	End If
	Return Me
...
Sub AddClassOnFalseCondition(bCondition As Boolean, sClass As String) As UOEHTML
	If bCondition = False Then
		AddClass(sClass)
	End If
	Return Me
...
Sub RemoveClassOnCondition(bCondition As Boolean, sClass As String) As UOEHTML
	If bCondition Then 
		removeClass(sClass)
	End If
	Return Me
...
Sub RemoveClassOnFalseCondition(bCondition As Boolean, sClass As String) As UOEHTML
	If bCondition = False Then 
		removeClass(sClass)
	End If
	Return Me
...
Sub AddContentList(lst As List) As UOEHTML
...
Sub SetText(sText As String) As UOEHTML
	AddContent(sText)
	Return Me
End Sub

Sub SetCode(sText As String) As UOEHTML
	Dim sb As StringBuilder
	sb.Initialize 
...
Sub AddText(txt As String) As UOEHTML
	AddContent(txt)
	Return Me
End Sub

'set prefix
Sub SetPrefix(sPrefix As String) As UOEHTML
	Prefix = sPrefix
	Return Me
End Sub

'set id
Sub SetID(sID As String) As UOEHTML
	sID = sID.tolowercase
	ID = sID
	Return Me
End Sub
...
Sub SetTag(sTag As String) As UOEHTML
	Tag = sTag
	Return Me
End Sub

'set parent id
Sub SetParentID(sParentID As String) As UOEHTML
	ParentID = sParentID
	Return Me
End Sub

'set read only
Sub SetReadOnly(bReadOnly As Boolean) As UOEHTML
	ReadOnly = bReadOnly
	Return Me
End Sub

'set max
Sub SetMax(m As Object) As UOEHTML
	SetAttr("max", m)
	Return Me
End Sub
...
'set inline
Sub SetInline(bInline As Boolean) As UOEHTML
	Inline = bInline
	Return Me
End Sub

'set enabled
Sub SetEnabled(bEnabled As Boolean) As UOEHTML
	Enabled = bEnabled
	Return Me
End Sub

'set required
Sub SetRequired(bRequired As Boolean) As UOEHTML
	Required = bRequired
	Return Me
End Sub

'Initializes the html builder
Public Sub Initialize(elID As String) As UOEHTML
	elID = CStr(elID)
	IsImportant = True
	SBBefore.Initialize 
	SBAfter.Initialize 
...
Sub SetSublink1(b As Boolean) As UOEHTML   'ignore
	AddClass("sublink-1")
	Return Me
End Sub

Sub SetSublink2(b As Boolean) As UOEHTML  'ignore
	AddClass("sublink-2")
	Return Me
End Sub

Sub Pop(pElement As UOEHTML)
	pElement.AddElement(Me)
End Sub

'remove a data attribute
public Sub RemoveAttrData(sData As String) As UOEHTML
	sData = $"data-${sData}"$
	RemoveAttr(sData)
	Return Me
End Sub

Sub RemoveAttributeOnCondition(bCondition As Boolean, prop As String) As UOEHTML
	If bCondition Then
		RemoveAttr(prop)
	End If
	Return Me
...
'remove attribute
Sub RemoveAttribute(prop As String) As UOEHTML
	RemoveAttr(prop)
	Return Me	
End Sub

'remove an attribute from the ones set
public Sub RemoveAttr(sName As String) As UOEHTML
...
'remove an attribute from the ones set 
public Sub RemoveStyle(styleName As String) As UOEHTML
...
Sub SetAttrLoose(value As String) As UOEHTML
	AddLooseAttribute(value)
	Return Me
End Sub
...
Sub SetAttrData(prop As String, value As String) As UOEHTML
...
'add content to the element 
public Sub AddContent(value As String) As UOEHTML
	value = CStr(value)
	If value.Length > 0 Then
		value = FormatText(value)
		Contents.Add(value)
...
public Sub AddContentAfter(value As String) As UOEHTML
	value = CStr(value)
	If value.Length > 0 Then
		value = FormatText(value)
...
public Sub AddContentBefore(value As String) As UOEHTML
	value = CStr(value)
	If value.Length > 0 Then
		value = FormatText(value)
...
'remove a class
public Sub removeClass(className As String) As UOEHTML
...
'add an element
public Sub AddElement(el As UOEHTML) As UOEHTML
	If el <> Null Then
...
'add elements
Sub AddElements(lst As List) As UOEHTML
	For Each el As UOEHTML In lst
		AddElement(el)
	Next
	Return Me
End Sub
...
Sub AddStyle(prop As String, value As String) As UOEHTML
	AddStyleAttribute(prop,value)
	Return Me
End Sub

'set a style property
Sub AddStyleAttribute(sprop As String, svalue As String) As UOEHTML
...
'add a class to the element
Sub AddClass(value As String) As UOEHTML
...
'set attribute
public Sub AddAttribute(skey As String, svalue As String) As UOEHTML
	skey = CStr(skey)
	svalue = CStr(svalue)
...
Sub AddMailTo(emailaddress As String,subject As String,caption As String) As UOEHTML
	subject = subject.Replace(" ", "%20")
	Dim a As UOEHTML
	a.Initialize("").SetTag("a").setHREF($"mailto:${emailaddress}?subject=${subject}"$).AddContent(caption).SetTARGETblank(True)
	AddContent(a.ToString)
	Return Me
End Sub

Sub SetWarning(b As Boolean) As UOEHTML   'ignore
	AddClass("warning")
	Return Me
End Sub

Sub SetError(b As Boolean) As UOEHTML  'ignore
	AddClass("error")
	Return Me
End Sub

Sub SetMedia(b As Boolean) As UOEHTML   'ignore
	AddClass("media")
	Return Me
End Sub


Sub AddDiv(divid As String, divContent As String, divClass As String) As UOEHTML
	Dim div As UOEHTML
	div.Initialize(divid).SetTag("div").SetText(divContent).addclass(divClass)
	AddContent(div.HTML)
	Return Me
End Sub
...
'add a bold text
Sub AddBold(value As String) As UOEHTML
	Dim sb As StringBuilder
	sb.Initialize
...
'add italic text
Sub AddItalic(value As String) As UOEHTML
	Dim sb As StringBuilder
	sb.Initialize
...
'add underlined text
Sub AddUnderline(value As String) As UOEHTML
	Dim sb As StringBuilder
	sb.Initialize
...
'add subscript text
Sub AddSubScript(value As String) As UOEHTML
	Dim sb As StringBuilder
	sb.Initialize
...
Sub AddSuperScript(value As String) As UOEHTML
	Dim sb As StringBuilder
	sb.Initialize
...
Sub AddSub(value As String) As UOEHTML
	Dim sb As StringBuilder
	sb.Initialize
	sb.Append("<sub>").Append(value).Append("</sub>")
	AddContent(sb.ToString)
...
Sub AddKBD(value As String) As UOEHTML
	Dim sb As StringBuilder
	sb.Initialize
...
Sub AddCode(value As String) As UOEHTML
	Dim sb As StringBuilder
	sb.Initialize
...
Sub AddPre(value As String) As UOEHTML
	Dim sb As StringBuilder
	sb.Initialize
...
Sub AddSup(value As String) As UOEHTML
	Dim sb As StringBuilder
	sb.Initialize
	sb.Append("<sup>").Append(value).Append("</sup>")
	AddContent(sb.ToString)
...
'add a break
Sub AddBreak(b As Boolean) As UOEHTML  'ignore
	AddContent("{BR}")
	Return Me
End Sub

'add a hyperlink that opens to blank
Sub AddLink(href As String,caption As String,Target As String) As UOEHTML
	Dim a As UOEHTML
	a.Initialize("").SetTag("a").SetHREF(href).AddContent(caption).SetTARGET(Target)
	AddElement(a)
	Return Me
End Sub

Sub AddAnchor(href As String,caption As String,Target As String) As UOEHTML
	AddLink(href,caption,Target)
	Return Me
End Sub


Sub AddH1(paraText As String) As UOEHTML
	AddContent($"<h1>${paraText}</h1>"$)
	Return Me
End Sub

Sub AddH2(paraText As String) As UOEHTML
	AddContent($"<h2>${paraText}</h2>"$)
	Return Me
End Sub

Sub AddH3(paraText As String) As UOEHTML
	AddContent($"<h3>${paraText}</h3>"$)
	Return Me
End Sub

Sub AddH4(paraText As String) As UOEHTML
	AddContent($"<h4>${paraText}</h4>"$)
	Return Me
End Sub

Sub AddStrong(paraText As String) As UOEHTML
	AddContent($"<strong>${paraText}</strong>"$)
	Return Me
End Sub

Sub AddSmall(paraText As String) As UOEHTML
	AddContent($"<small>${paraText}</small>"$)
	Return Me
End Sub

Sub AddEM(paraText As String) As UOEHTML
	AddContent($"<em>${paraText}</em>"$)
	Return Me
End Sub


Sub AddH5(paraText As String) As UOEHTML
	AddContent($"<h5>${paraText}</h5>"$)
	Return Me
End Sub

Sub AddH6(paraText As String) As UOEHTML
